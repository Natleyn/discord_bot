...
module Roll; module WMS2
	@@WMS2_effects = {
		...
		2328 => "Caster's spellbook contains pages and pages of risqu� woodcuts ",
		...
		4148 => "Anyone cutting target with a blade feels unsettling d�j� vu ",
		...
		10001 => "Target gains a pink pony tulpa which constantly tries to get them to turn the current situation into a party."
	}

	def self.roll_WMS()
		roll = rand(1..@@WMS2_effects.length)
		return "Rolled a #{roll}: #{@@WMS2_effects[roll]}"
	end
end; end # Roll, WMS2
